...
namespace Test
{
    ...
    internal static class AddComplementaryIonsTest
    {
        ...
        public static void TestAddComplementaryIonsClassic()
        {
            ...
            CommonParameters CommonParameters = new CommonParameters(digestionParams: new DigestionParams(protease: protease.Name, maxMissedCleavages: 0, minPeptideLength: 1), scoreCutoff: 1, addComplementaryIons: false);
            ...
            CommonParameters CommonParameters2 = new CommonParameters(digestionParams: new DigestionParams(protease: protease.Name, maxMissedCleavages: 0, minPeptideLength: 1), scoreCutoff: 1, addComplementaryIons: true);
        ...
        public static void TestComplementaryIons_ModernSearch()
        {
            ...
            CommonParameters withCompIons = new CommonParameters(digestionParams: new DigestionParams(protease: protease.Name, minPeptideLength: 1), scoreCutoff: 1, addComplementaryIons: true);
